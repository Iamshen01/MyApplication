 ...
 */
public class MidLayout extends FrameLayout {
    public static final String TAG = "MidLayout";

    public MidLayout(Context context) {
        super(context);
    }

    public MidLayout(Context context, AttributeSet attrs) {
